            ...
            <nav className="navbar">
                ...
                <div className="links">
                    ...
                    <ul className="icons">
                        ...
                        <li><p className='icon-link'><a href="https://www.instagram.com/mariamabdelrahman203/" target="_blank" rel="noopener noreferrer" ><FontAwesomeIcon icon={faInstagram} /></a></p></li>
